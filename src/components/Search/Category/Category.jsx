...
const categories = [
    { title: "간식/사료", items: ['영양제', '수제간식', '덴탈껌', '건식사료', '습식사료'] },
    { title: "유모차", items: ['소형견', '대형견', '다인승', '큐션'] },
    { title: "의류", items: ['상의', '원피스', '아우터/우비', '수영복', '악세사리'] },
    { title: "용품", items: ['미용용품', '장난감', '방석', '위생용품', '산책용품', '가방/카시트'] },
];
                            ...
                            <div css={styles.categorySection} key={category.title}>
                                ...
                                <ul css={styles.itemList}>
                                    {category.items.map((item, index) => (
                                        <li css={styles.item} key={index}>{item}</li>
                                    ))}
                                </ul>
                            </div>
                        ))}
